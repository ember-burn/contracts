...
contract VaultFactory {
    ...
    event AuctionMinimumChanged(uint256 indexed oldMinimum, uint256 indexed newMinimum);
    ...
    event AuctionMaximumChanged(uint256 indexed oldMaximum, uint256 indexed newMaximum);
    ...
    constructor(uint256 _minAuctionLength, uint256 _maxAuctionLength, address _admin) {
