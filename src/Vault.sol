...
contract Vault is ERC20 {	
    ...
    constructor(
		...
		require(
			(_auctionEnd - _auctionStart) > _minAuctionLength &&
			(_auctionEnd - _auctionStart) > _maxAuctionLength
		);
    ...
    function updateFee(uint256 _newBps) external onlyAdmin payable {
		assembly {
    ...
    function updateStart(uint256 _newStart) external onlyAdmin payable {
		require(
